...
class WebsiteStatsTest {
    ...
    private static String getContentFromFile(@NonNull final String path) {
        final ClassLoader classLoader = WebsiteStatsTest.class.getClassLoader();
    ...
    private WebsiteStats setUpWebsiteStats(final String htmlContentPath) {
        final WebsiteStats websiteStats = spy(new WebsiteStats());
    ...
    void retrievePlayerStats_Empty() {
        ...
        final WebsiteStats websiteStats = this.setUpWebsiteStats("website/" + playerName);

        final Optional<WebsitePlayerModel> dataOpt = websiteStats.retrievePlayerStats(playerName);
